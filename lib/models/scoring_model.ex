defmodule ScoreApi.ScoringModel do
  ...
  def update_scores(topic_ids) do
    ...
    query = "update content_topics as ct set ct.score = (select max(score) from channel_contents where topic_id=ct.topic_id and status =0) where ct.topic_id in #{joined_ids} "
